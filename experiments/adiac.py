...
if args.ron:
    f = open(os.path.join(args.resultroot, f"Adiac_log_RON_{args.topology}.txt"), "a")
elif args.pron:
    f = open(os.path.join(args.resultroot, "Adiac_log_PRON.txt"), "a")
elif args.mspron:
    f = open(os.path.join(args.resultroot, "Adiac_log_MSPRON.txt"), "a")
elif args.esn:
    f = open(os.path.join(args.resultroot, "Adiac_log_ESN.txt"), "a")
else:
    raise ValueError("Wrong model choice.")
