...
from ads.benchmarks import get_mackey_glass
...
for i in range(args.trials):
    ...
    (train_dataset, train_target), (valid_dataset, valid_target), (test_dataset, test_target) = get_mackey_glass(args.dataroot)
